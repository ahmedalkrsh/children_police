...
import 'package:children_police/features/calling/presentation/widgets/pulese_badg.dart';
import 'package:children_police/features/calling/presentation/widgets/sound_wave_indicator.dart';
import 'package:children_police/features/calling/presentation/widgets/wave_animation.dart';
            ...
            Container(
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    WaveAnimation(animation: _callController.waveAnimation),
                    PulseBadge(animation: _callController.pulseAnimation),
